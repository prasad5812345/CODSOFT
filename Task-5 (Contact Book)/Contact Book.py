{
 "cells": [
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "# Defining the ContactBook Class with the functions(add, view, search, update, delete contacts)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "        \n",
    "        # to submit after filling the input data\n",
    "        def submit_contact():\n",
    "            name = name_entry.get()\n",
    ...
    "     \n",
    "    \n",
    "    # to edit and update the contacts\n",
